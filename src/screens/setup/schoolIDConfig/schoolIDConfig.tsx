...
const SchoolID = () => {
  ...
  return (
    <div>
      ...
      <Modal open={open} onCancel={() => setOpen(false)} centered title="Create School ID Setup" footer={null}>
        <CreateSchoolID handleClose={() => setOpen(false)} />
      </Modal>
      <Modal open={openEdit} onCancel={() => setOpenEdit(false)} centered title="Edit School ID Setup" footer={null}>
